...
execute unless score game_start exp_data matches 1 run tellraw @a [{"text":"[Expansion] ","color":"aqua"},{"text":"⚠ Datapack has been found, but game has not been started yet. Use ","color":"red"},{"text":"config book","color":"#ff4778","bold":true},{"text":" to start game.","color":"red"}]
