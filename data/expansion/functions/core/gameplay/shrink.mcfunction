# Executed if on easy
execute if score difficulty exp_data matches 1 in overworld run worldborder add -5 1
...
execute if score difficulty exp_data matches 2 in overworld run worldborder add -8 1 
...
# Executed if on hard
execute if score difficulty exp_data matches 3 in overworld run worldborder add -10 1
...
execute if score difficulty exp_data matches 4..5 in overworld run worldborder add -12 1
