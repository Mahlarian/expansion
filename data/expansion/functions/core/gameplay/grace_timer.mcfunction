...
bossbar set expansion:timer name [{"text":"Grace period ending in ","color":"white"},{"score":{"name":"grace_m","objective":"exp_timer"},"color":"aqua"},{"text":"m "},{"score":{"name":"grace_s","objective":"exp_timer"},"color":"aqua"},{"text":"s"}]
