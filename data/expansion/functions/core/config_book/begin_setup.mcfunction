...
tellraw @a[scores={exp_config_op=1..}] [{"text":"Config Mode - ","color":"aqua","bold":true},{"text":"Enabled\n","color":"green"},{"text":"Interacting with the world is not recommended while this mode is active\n\n","color":"red","bold":false},{"text":"While holding an item in your hand, press your ","color":"white","bold":false},{"text":"DROP","color":"light_purple"},{"text":" key to apply the setting\nWhen you are finished, you can drop ","color":"white","bold":false},{"text":"Slot #9 ","color":"light_purple"},{"text":"or click ","color":"white","bold":false},{"text":"here","color":"red","underlined":true,"hoverEvent":{"action":"show_text","contents":[{"text":"Clicking this text will exit Config Mode"}]},"clickEvent":{"action":"run_command","value":"function expansion:core/config_book/exit_setup"}},{"text":"\nTip: "},{"text":" Hover over an item in your inventory for more information on the setting","color":"white","bold":false},{"text":"\nSaving/Reloading is not necessary, your changes are made automatically and will take place when the game starts!","color":"gray"}]
