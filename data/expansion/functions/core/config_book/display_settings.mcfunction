...
execute unless score difficulty exp_data matches 1..5 run tellraw @s {"text":"- An Issue occurred while showing DIFFICULTY value. Value is either too low or too high, or it doesn't exist.","color":"red"}
# spawn point
...
execute if score spawn_ref exp_data matches 3 run tellraw @s [{"text":"- When the game starts, ","color":"white"},{"text":"custom location","color":"light_purple"},{"text":" will be used as the center of the border","color":"white"}]
...
execute unless score spawn_ref exp_data matches 1..4 run tellraw @s {"text":"- An Issue occurred while showing SPAWN_REF value. Value is either too low or too high, or it doesn't exist.","color":"red"}
# grace period
...
execute unless score grace_period exp_data matches 0..1 run tellraw @s {"text":"- An Issue occurred while showing GRACE_PERIOD value. Value is either too low or too high, or it doesn't exist.","color":"red"}
